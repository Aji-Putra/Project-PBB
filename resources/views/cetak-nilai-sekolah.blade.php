...
<body>
            ...
            @foreach ($juri1 as $pbb1)
                ...
                <tr>
                    ...
                    <td>
                        @php
                            $sikapSempurna =
                                $pbb1->sikap_sempurna +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->sikap_sempurna ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->sikap_sempurna ?? 0);
                        @endphp
                        {{ $sikapSempurna }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $istirahatDiTempat =
                                $pbb1->istirahat_di_tempat +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->istirahat_di_tempat ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->istirahat_di_tempat ?? 0);
                        @endphp
                ...
                <tr>
                    ...
                    <td>
                        @php
                            $hormat =
                                $pbb1->hormat +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->hormat ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->hormat ?? 0);
                        @endphp
                        {{ $hormat }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $periksaKerapihan =
                                $pbb1->periksa_kerapihan +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->periksa_kerapihan ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->periksa_kerapihan ?? 0);
                        @endphp
                        {{ $periksaKerapihan }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>{{ $juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->setengah_lengan_lencang_kiri ?? 0 }}
                    </td>
                    <td>{{ $juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->setengah_lengan_lencang_kiri ?? 0 }}
                    </td>
                    <td>
                        @php
                            $lencangKiri =
                                $pbb1->setengah_lengan_lencang_kiri +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->setengah_lengan_lencang_kiri ??
                                    0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->setengah_lengan_lencang_kiri ??
                                    0);
                        @endphp
                        {{ $lencangKiri }}
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        @php
                            $lencangKanan =
                                $pbb1->lencang_kanan +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->lencang_kanan ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->lencang_kanan ?? 0);
                        @endphp
                        {{ $lencangKanan }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $hadapKanan =
                                $pbb1->hadap_kanan +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->hadap_kanan ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->hadap_kanan ?? 0);
                        @endphp
                        {{ $hadapKanan }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $lencangDepan =
                                $pbb1->lencang_depan +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->lencang_depan ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->lencang_depan ?? 0);
                        @endphp
                        {{ $lencangDepan }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $hadapKiri =
                                $pbb1->hadap_kiri +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->hadap_kiri ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->hadap_kiri ?? 0);
                        @endphp
                        {{ $hadapKiri }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $jalanDiTempat =
                                $pbb1->jalan_di_tempat +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->jalan_di_tempat ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->jalan_di_tempat ?? 0);
                        @endphp
                        {{ $jalanDiTempat }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $balikKananHenti =
                                $pbb1->balik_kanan_henti +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->balik_kanan_henti ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->balik_kanan_henti ?? 0);
                        @endphp
                        {{ $balikKananHenti }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $tigaLangkahKanan =
                                $pbb1->tiga_langkah_kanan +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->tiga_langkah_kanan ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->tiga_langkah_kanan ?? 0);
                        @endphp
                        {{ $tigaLangkahKanan }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $tigaLangkahKiri =
                                $pbb1->tiga_langkah_kiri +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->tiga_langkah_kiri ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->tiga_langkah_kiri ?? 0);
                        @endphp
                        {{ $tigaLangkahKiri }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $tigaLangkahDepan =
                                $pbb1->tiga_langkah_depan +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->tiga_langkah_depan ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->tiga_langkah_depan ?? 0);
                        @endphp
                        {{ $tigaLangkahDepan }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $tigaLangkahBelakang =
                                $pbb1->tiga_langkah_belakang +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->tiga_langkah_belakang ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->tiga_langkah_belakang ?? 0);
                        @endphp
                        {{ $tigaLangkahBelakang }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $majuJalan =
                                $pbb1->maju_jalan +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->maju_jalan ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->maju_jalan ?? 0);
                        @endphp
                        {{ $majuJalan }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $langkahTegap =
                                $pbb1->langkah_tegap +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->langkah_tegap ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->langkah_tegap ?? 0);
                        @endphp
                        {{ $langkahTegap }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $langkahBerlari =
                                $pbb1->langkah_berlari +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->langkah_berlari ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->langkah_berlari ?? 0);
                        @endphp
                        {{ $langkahBerlari }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $hormatKiri =
                                $pbb1->hormat_kiri +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->hormat_kiri ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->hormat_kiri ?? 0);
                        @endphp
                        {{ $hormatKiri }}
                    </td>
                </tr>
                    ...
                    <td>
                        @php
                            $tiapBanjarBelokKanan =
                                $pbb1->tiap_banjar_belok_kanan +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->tiap_banjar_belok_kanan ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->tiap_banjar_belok_kanan ?? 0);
                        @endphp
                        {{ $tiapBanjarBelokKanan }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $melintangKiri =
                                $pbb1->melintang_kiri +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->melintang_kiri ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->melintang_kiri ?? 0);
                        @endphp
                        {{ $melintangKiri }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $haluanKiri =
                                $pbb1->haluan_kiri +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->haluan_kiri ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->haluan_kiri ?? 0);
                        @endphp
                        {{ $haluanKiri }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $tiapBanjarBelokKiri =
                                $pbb1->tiap_banjar_belok_kiri +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->tiap_banjar_belok_kiri ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->tiap_banjar_belok_kiri ?? 0);
                        @endphp
                        {{ $tiapBanjarBelokKiri }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $bubarJalan =
                                $pbb1->bubar_jalan +
                                ($juri2->firstWhere('sekolah_id', $pbb1->sekolah_id)->bubar_jalan ?? 0) +
                                ($juri3->firstWhere('sekolah_id', $pbb1->sekolah_id)->bubar_jalan ?? 0);
                        @endphp
                        {{ $bubarJalan }}
                    </td>
                </tr>
        ...
        @foreach ($vaforData as $vafor)
            @php
                $totalKeseluruhan =
                    ...
                    $totalnilaiVafor =+ $totalKeseluruhan
            @endphp
            <tbody>
                <tr>
    ...
    <table>
        ...
        @php
            $totalKeseluruhanPenalti = 0; // Variabel untuk menyimpan total semua penalti
            $adaDiskualifikasi = false; // Variabel untuk menyimpan status diskualifikasi
        @endphp
        @foreach ($penaltiData as $penalti)
            @php
                ...
                $totalKeseluruhanPenalti += $totalPenalti;
            @endphp
    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td>{{ $totalnilaiPBB + $totalnilaiDanton +$totalnilaiVafor + $totalnilaipasukan  - $totalKeseluruhanPenalti}}</td>
            </tr>
        </tbody>
    </table>
