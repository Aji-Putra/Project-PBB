    ...
    <div class="flex gap-2 items-center justify-between">
        ...
        <div id="kerapihan_saf" class="flex flex-wrap gap-4 bg-white p-1 px-2 rounded">
            ...
            <div>
                ...
                <label for="kerapihan_saf_<?= $value ?>" class="block border border-gray-500 cursor-pointer select-none rounded-xl p-1 <?= $paddingClass ?> text-center peer-checked:bg-blue-500 peer-checked:font-bold peer-checked:text-white transition-all"><?= $value ?></label>
            </div>
            <?php endforeach; ?>
        </div>
    </div>
    <div class="flex gap-2 items-center justify-between">
        ...
        <div id="kerapihan_banjar" class="flex flex-wrap gap-4 bg-white p-1 px-2 rounded">
            ...
            <div>
                ...
                <label for="kerapihan_banjar_<?= $value ?>" class="block border border-gray-500 cursor-pointer select-none rounded-xl p-1 <?= $paddingClass ?> text-center peer-checked:bg-blue-500 peer-checked:font-bold peer-checked:text-white transition-all"><?= $value ?></label>
            </div>
            <?php endforeach; ?>
        </div>
    </div>
    <div class="flex gap-2 items-center justify-between">
        ...
        <div id="kekompakan_gerak" class="flex flex-wrap gap-4 bg-white p-1 px-2 rounded">
            ...
            <div>
                ...
                <label for="kekompakan_gerak_<?= $value ?>" class="block border border-gray-500 cursor-pointer select-none rounded-xl p-1 <?= $paddingClass ?> text-center peer-checked:bg-blue-500 peer-checked:font-bold peer-checked:text-white transition-all"><?= $value ?></label>
            </div>
            <?php endforeach; ?>
        </div>
    </div>
    <div class="flex gap-2 items-center justify-between">
        ...
        <div id="penempatan_ketinggian_personel" class="flex flex-wrap gap-4 bg-white p-1 px-2 rounded">
            ...
            <div>
                ...
                <label for="penempatan_ketinggian_personel_<?= $value ?>" class="block border border-gray-500 cursor-pointer select-none rounded-xl p-1 <?= $paddingClass ?> text-center peer-checked:bg-blue-500 peer-checked:font-bold peer-checked:text-white transition-all"><?= $value ?></label>
            </div>
            <?php endforeach; ?>
        </div>
    </div>
    <div class="flex gap-2 items-center justify-between">
        ...
        <div id="formasi_keseluruhan" class="flex flex-wrap gap-4 bg-white p-1 px-2 rounded">
            ...
            <div>
                ...
                <label for="formasi_keseluruhan_<?= $value ?>" class="block border border-gray-500 cursor-pointer select-none rounded-xl p-1 <?= $paddingClass ?> text-center peer-checked:bg-blue-500 peer-checked:font-bold peer-checked:text-white transition-all"><?= $value ?></label>
            </div>
            <?php endforeach; ?>
        </div>
    </div>
