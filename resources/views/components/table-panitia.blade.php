                ...
                <tr class="hover:bg-slate-700">
                    ...
                    <td class="p-4 border-b border-slate-700 bg-slate-800">
                        <div class="flex gap-4 items-center">
                            @if ($item->status === 'DISKUALIFIKASI')
                                <p class="text-sm font-medium w-full text-slate-300">DISKUALIFIKASI</p>
                            @elseif ($item->status !== 'Sudah Registrasi')
                            ...
                            @php
                                $sudahAdaPenalti = DB::table('nilai_penalti')
